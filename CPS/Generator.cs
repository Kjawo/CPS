...
namespace CPS
{
    public class Generator
    {
        ...
        public enum SignalEnum
        {
            ...
            unitStep, unitImpulse, impulseNoise
        }
        ...
        public static BaseSignal GetSelectedSignal(SignalWrapper s)
        {
            switch (s.Signal)
            {
                ...
                case SignalEnum.squareWave:
                    return new SquareWaveSignal();
                case SignalEnum.squareWaveSymetrical:
                    return  new SquareWaveSymetricalSignal();
                case SignalEnum.triangleWave:
                    return new TriangleWave();
                case SignalEnum.unitStep:
                    return new UnitStep();
                case SignalEnum.unitImpulse:
                    return new UnitImpulse();
                case SignalEnum.impulseNoise:
